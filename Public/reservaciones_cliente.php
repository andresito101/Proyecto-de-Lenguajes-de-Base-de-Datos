...
<body>
    <div class="container mt-4">
        <h1>Gestión de Reservaciones de Clientes</h1>

        <!-- Formulario para agregar/editar una reservación -->
        <form id="formReservacionesCliente" method="POST" action="ReservacionesClienteController.php">
            <div class="row">
        ...
        <table class="table table-striped mt-4">
            ...
            <tbody>
                <?php
                require_once 'ReservacionesClienteController.php';
                ...
                foreach ($reservaciones as $reservacion) {
                    echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='ReservacionesClienteController.php?accion=eliminar&ID_Reservacion={$reservacion['ID_Reservacion']}' class='btn btn-danger btn-sm'>Eliminar</a>
                        </td>
                    </tr>";
                }
                ?>
